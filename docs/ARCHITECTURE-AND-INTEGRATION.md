...
## طبقة تنقل القائمة الجانبية

يستخدم `MainLayoutComponent` قائمة مجمعة حسب المجال، ويعرض مركز المجال ثم الوحدات
التشغيلية التابعة له كرابط مباشر مع أيقونة صغيرة. هذا يحافظ على التجميع دون إخفاء
الموارد خلف بطاقات أو الاعتماد على البحث، ولا ينشئ تطبيقات منفصلة أو نسخًا من المكونات؛
الصفحات التشغيلية والخدمات الحالية تبقى lazy-loaded على مساراتها الأصلية. كل رابط يُفلتر
حسب الصلاحية، بينما يظل Route Guard والـPlatform API مصدر القرار الأمني النهائي.
