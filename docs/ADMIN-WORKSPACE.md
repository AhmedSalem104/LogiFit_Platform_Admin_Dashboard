...
## قائمة لوحة الإدارة المجمعة

القائمة الجانبية تعرض المراكز والوحدات التشغيلية كلها كرابط مباشر واضح، مع أيقونة صغيرة
بجوار اسم كل شاشة. يحافظ ذلك على التجميع الحالي وترتيب الوحدات داخل كل مجال، ويجعل
النسخ الاحتياطية وموارد قواعد البيانات وباقي الموارد ظاهرة دون الحاجة إلى فتح مركز أو
استخدام البحث:

| المجال | المسار | الوحدات التابعة |
|---|---|---|
...
الروابط لا تستبدل الصفحات أو عقود الـAPI؛ هي طبقة تنقل وتجميع فقط. تبقى المسارات الأصلية
صالحة للروابط المباشرة والمساعد والأذونات. لا تُعتبر رؤية الرابط حماية؛ permissionGuard
وPlatform API هما مصدر القرار، ولا يظهر الرابط إلا إذا امتلك المستخدم صلاحيته.
