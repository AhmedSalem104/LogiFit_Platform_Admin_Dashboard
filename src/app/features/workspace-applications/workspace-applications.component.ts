...
export class WorkspaceApplicationsComponent implements OnInit {
  ...
  fieldHint(application: PlatformWorkspaceApplication): string { return application.applicationType === PlatformApplicationType.FreelanceWorkspaceCreation ? 'BrandName, Bio' : 'FullName'; }
