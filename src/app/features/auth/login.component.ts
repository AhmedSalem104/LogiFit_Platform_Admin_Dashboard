...
@Component({
  ...
  `,
  styles: [`
    :host{display:block;min-height:100vh}.login-shell{min-height:100vh;display:grid;place-items:center;padding:1.25rem;background:radial-gradient(circle at 15% 15%,#1d4ed8 0,transparent 28%),linear-gradient(145deg,#020617,#172554 65%,#1e3a8a)}.login-card{width:min(100%,440px);padding:1.7rem 2rem;border:1px solid rgba(255,255,255,.7);border-radius:1.5rem;background:rgba(255,255,255,.98);box-shadow:0 30px 90px rgba(2,6,23,.38)}.brand{display:flex;align-items:center;justify-content:center;gap:.65rem;margin-bottom:1.35rem}.brand>span{display:grid;place-items:center;width:44px;height:44px;border-radius:14px;background:linear-gradient(135deg,#2563eb,#4f46e5);color:#fff;font-weight:900}.brand div{display:grid}.brand b{color:#0f172a}.brand small{color:#64748b}.shield{display:grid;place-items:center;width:46px;height:46px;margin:0 auto .65rem;border-radius:14px;background:#eff6ff;color:#2563eb;font-size:1.2rem}header{text-align:center}h1{margin:0;color:#0f172a;font-size:1.5rem}header p{margin:.45rem 0 0;color:#64748b;line-height:1.7;font-size:.82rem}form{display:grid;gap:.55rem;margin-top:1.35rem}label{font-size:.82rem;font-weight:800;color:#334155}.field{position:relative;display:flex;align-items:center}.field>i{position:absolute;right:.9rem;color:#64748b}.field input{width:100%;box-sizing:border-box;padding:.7rem 2.6rem;min-height:48px;border:1px solid #d8deea;border-radius:10px;color:#0f172a;font:inherit}.field button{position:absolute;left:.55rem;border:0;background:transparent;color:#64748b}.field-error,.warning{margin:0;color:#be123c;font-size:.72rem}.warning{color:#b45309}.primary{display:flex;align-items:center;justify-content:center;gap:.45rem;min-height:48px;margin-top:.65rem;border:0;border-radius:10px;background:linear-gradient(135deg,#2563eb,#4f46e5);color:#fff;font:inherit;font-weight:800;box-shadow:0 10px 22px rgba(37,99,235,.24)}.primary:disabled{opacity:.55}.error{display:flex;gap:.4rem;padding:.7rem;border:1px solid #fecdd3;border-radius:9px;background:#fff1f2;color:#be123c;font-size:.78rem}footer{display:grid;justify-items:center;gap:.3rem;margin-top:1.4rem;color:#64748b;font-size:.72rem}footer small{color:#94a3b8}@media(max-width:480px){.login-shell{align-items:start;padding:1rem}.login-card{margin-top:3vh;padding:1.35rem}}
  `],
})
