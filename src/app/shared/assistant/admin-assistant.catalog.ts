...
export const ADMIN_ASSISTANT_GUIDES: AssistantGuide[] = [
  ...
  },
  {
    ...
    summary: 'إنشاء ومراجعة دورة موحدة للجيم والمدرب الحر وطلبات العضوية قبل منح أي وصول تشغيلي.',
    keywords: ['طلبات', 'جيم', 'Gym', 'مدرب حر', 'FreelanceCoach', 'freelance', 'اعتماد', 'موافقة', 'رفض', 'استكمال بيانات', 'مساحة عمل', 'تجهيز', 'قاعدة بيانات'],
    overview: 'اختر نوع المساحة عند الإنشاء: Gym أو FreelanceCoach. يمر الاثنان بنفس الطلب والدفع والمراجعة والتجهيز والتفعيل. راجع Timeline والحقول المنفصلة قبل اعتبار المساحة جاهزة؛ لا تظهر في هذه الصفحة Connection Material أو بيانات صحية أو تدريبية. كل قرار يخضع لحالة الطلب وrowVersion في الخادم؛ لا يملك المساعد تنفيذ قرار تلقائيًا.',
    steps: ['أنشئ مساحة عمل واختر Gym أو FreelanceCoach ثم أكمل بيانات المالك والباقة.', 'استخدم الفلاتر الخادمية لفصل النوع والدفع والتجهيز والاشتراك، ثم افتح Timeline للصف.', 'ابدأ المراجعة، اطلب الحقول المسموح بها عند النقص، أو استخدم اعتماد workspace المناسب؛ العضويات فقط تستخدم اعتماد membership.', 'راجع حالة الصف المحدثة وسجل التدقيق عند ظهور تعارض أو فشل، واستخدم إعادة المحاولة للتجهيز الفاشل فقط.'],
    ...
    buttons: [{ label: 'إنشاء مساحة', description: 'يفتح المعالج لاختيار Gym أو FreelanceCoach وإدخال المالك والباقة.' }, { label: 'بدء المراجعة', description: 'ينقل الطلب المقدم إلى قيد المراجعة.' }, { label: 'Timeline', description: 'يعرض حالات الطلب والدفع والتجهيز والاشتراك والوصول دون مواد اتصال.' }, { label: 'طلب استكمال', description: 'يرسل رسالة وحقولًا مسموحة فقط إلى مقدم الطلب.' }, { label: 'موافقة / رفض', description: 'قرار نهائي موثق في الخادم ولا ينفذه المساعد تلقائيًا.' }, { label: 'إعادة التجهيز', description: 'تعيد محاولة تجهيز فاشلة بنفس معرف الطلب دون إنشاء مساحة مكررة.' }, { label: 'تحديث', description: 'يعيد قراءة قائمة الطلبات من الخادم.' }],
