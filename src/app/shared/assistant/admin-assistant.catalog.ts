...
export const ADMIN_ASSISTANT_GUIDES: AssistantGuide[] = [
  {
    ...
    summary: 'صورة تنفيذية حية لصحة المنصة والاشتراكات والمدفوعات والتنبيهات.',
    keywords: ['الرئيسية', 'الرئيسيه', 'داش بورد', 'احصائيات', 'ملخص', 'صحة النظام'],
    overview: 'ابدأ من هنا لتحديد الأولويات: راقب المؤشرات، ثم انتقل إلى التنبيهات أو طلبات الدفع أو المستأجرين المتأثرين. لا تتخذ قراراً مالياً من رقم مجرد؛ افتح السجل المرتبط به أولاً.',
    steps: ['راجع البطاقات التي تحمل حالة تحذير أو قيمة غير معتادة.', 'افتح مركز التنبيهات لمتابعة المخاطر التشغيلية.', 'راجع طلبات الدفع المعلقة قبل تفعيل أي اشتراك.', 'استخدم البحث للوصول إلى العملية المطلوبة دون التنقل اليدوي.'],
    warnings: ['المؤشرات للمتابعة وليست بديلاً عن سجل المراجعة أو الفاتورة.', 'كل الأوقات التي يعرضها النظام مبنية على UTC في الخادم ثم تُنسّق للعرض.'],
    buttons: [{ label: 'مركز التنبيهات', description: 'يفتح التنبيهات التشغيلية الحالية.' }, { label: 'طلبات الدفع', description: 'يفتح الطلبات التي تحتاج قراراً إدارياً.' }, { label: 'تحديث', description: 'يعيد قراءة المؤشرات من الخادم دون تعديل بيانات.' }],
    quickActions: [
  ...
  },
  {
    ...
    overview: 'تحتوي النسخة على Schema وData الفعليين حسب إعداد الخادم. إنشاء النسخة وتنزيلها يتطلبان صلاحية مستقلة، ولا يتم حذف السجلات التاريخية من اللوحة.',
    steps: ['تأكد أن خدمة النسخ مفعلة في الخادم.', 'أنشئ نسخة عند الحاجة أو راجع النسخ الدورية.', 'انتظر اكتمال الحالة قبل التنزيل.', 'احفظ الملف في مكان محمي واختبر الاستعادة خارج الإنتاج.'],
    warnings: ['زر التنزيل يعيد 404 إذا كان الخادم منشوراً بإصدار أقدم من Endpoint التنزيل.', 'لا تشارك ملف النسخة الاحتياطية أو تخزنه في مسار عام؛ يحتوي على بيانات حقيقية.'],
    buttons: [{ label: 'إنشاء نسخة', description: 'يبدأ إنشاء نسخة وفق إعداد الخادم بعد تأكيد.' }, { label: 'تنزيل', description: 'ينزل ملف النسخة بعد اكتمالها.' }, { label: 'تحديث الحالة', description: 'يعيد قراءة قائمة النسخ وحالة الخدمة.' }, { label: 'الترقيم', description: 'يتنقل في سجل النسخ دون حذف السجلات التاريخية.' }],
    quickActions: [
