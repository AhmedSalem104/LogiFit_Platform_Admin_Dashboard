...
export const NAV_ITEMS: NavItem[] = [
  ...
  { label: 'المنشآت الرياضية', icon: 'pi pi-building', route: '/tenants', permissions: ['ManageTenants'] },
  ...
  { label: 'كتالوج الميزات', icon: 'pi pi-star', route: '/features', permissions: ['ManagePlans'] },
  ...
  { label: 'النسخ الاحتياطية', icon: 'pi pi-database', route: '/backups', permissions: ['ManagePlatformBackups'] },
  ...
  { label: 'مديرو المنصة', icon: 'pi pi-users', route: '/administrators', permissions: ['ManagePlatformReports'] },
  ...
  { label: 'مركز التنبيهات', icon: 'pi pi-bell', route: '/alerts', permissions: ['ManagePlatformReports'] },
  { label: 'المرجع والدليل', icon: 'pi pi-book', route: '/documentation', permissions: ['ManagePlatformReports'] },
